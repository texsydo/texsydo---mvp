        ...
        <section className="bg-strip fx">
            <div className="bg">
                <div className="wrap">
                    ...
                    <p>
                        Texsydo renders text as mathematical art in effectful
                    ...
                    <p>Continuous Development with Documentation Assistance</p>
                    ...
                    <p>
                        The above command will show a preview window with the
                        rendered image.
                    </p>

                    <p>
                        FX will save the image by removing
                        the <InlineCode>preview</InlineCode> unnamed parameter
                        and specifying
                    ...
                    <figure className={ "mx-lg-5 my-4" }>
                        <img
                            src={ prCoverWithCustomColor }
                            alt="PR Cover with Custom Color"
                        />
                        <figcaption>PR Cover with Custom Color</figcaption>
                    </figure>
                    ...
                    <figure className={ "mx-lg-5 my-4" }>
                        ...
                        />
                        <figcaption>PR Cover in MathSwe Ops</figcaption>
                    </figure>
                    ...
                    <figure className={ "mx-lg-5 my-4" }>
                        ...
                        />
                        <figcaption>Release Cover in MathSwe Legal</figcaption>
                    </figure>
                    ...
                    <p>
                        ...
                        development context from PRs and releases and calls FX
                        to streamline article graphics under MathSwe standards.
                    </p>
                </div>
            </div>
        </section>
